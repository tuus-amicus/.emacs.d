...
#+begin_src emacs-lisp
  ;; No needs to use auto-complete, where is company enabled
...
#+END_SRC
Make it compataible with company-mode in elpy
[[https://github.com/jorgenschaefer/elpy/wiki/FAQ][How to solve company, yasnippet conflicts?]]
...
**** Elpy
[[https://github.com/jorgenschaefer/elpy/wiki][GithubWiki]]
...
;; Install virtualenv with wrapper for python install correctness
...
- [X] Setup fzf with emacs. [1/1]
  - [X] Setup gitignore (fd utility)
- [X] Setup ibuffer (or buffer) to orginize content by file extensions or by modes
- [X] Python as IDE:  [[https://habr.com/ru/post/303600/][First tutor]]
- [X] Setup python with yasnippets like sublime (auto indent, competition)
- [X] Setup counsel-fzf 
  * Try with hydra
    or
  * Try with setq counsel--fzf-directory or simmilar
- [X] Check how save backup files with # in .emacs.d only
- [X] Python support (highlight & autocomplete & indent & virtualenvironments)
- [X] Add support of 'Find everywhere swipper or councel' find file -> type short, searches everywhere, starts ./*
- [X] Make as in [[https://github.com/hlissner/doom-emacs/tree/screenshots][DoomEmacs]]: [100%]
  - [X] Tab emulation
...
There is list of packages i am used to use. Check of installing required:
